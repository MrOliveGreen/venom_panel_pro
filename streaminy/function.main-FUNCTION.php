...
function portal_auth($sn, $mac, $ver, $stb_type, $image_version, $device_id, $device_id2, $hw_version, $req_ip)
{
	...
	if (0 < count($obf_DQ0OESs8GSEoOQUEASQvIz9cLBMxEBE)) {
		...
		if (($obf_DSYeDA4WMQgcKBUGBCZANxIpERYWXBE['sn'] == $sn) && ($obf_DSYeDA4WMQgcKBUGBCZANxIpERYWXBE['hw_version'] == $hw_version) && ($obf_DSYeDA4WMQgcKBUGBCZANxIpERYWXBE['device_id2'] == $device_id2) && ($obf_DSYeDA4WMQgcKBUGBCZANxIpERYWXBE['device_id'] == $device_id) && ($obf_DSYeDA4WMQgcKBUGBCZANxIpERYWXBE['image_version'] 