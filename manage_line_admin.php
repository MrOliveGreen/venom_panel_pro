...
{
  $id = base64_decode($_POST['check_id']);
  $result = $get->check_line($id);
  if($result)
  {
    $flag = 1;
    $alert = 'Line Banned Successfully!';
...
$("#line_li").addClass("active");
  ...
  var table = $('#table').dataTable( {
    ...
    "bProcessing": true,
    "bServerSide": true,
    "sAjaxSource": "common//line_processing.php",
    "aoColumns":[
        {"bSortable": true},
        {"bSortable": true},
        {"bSortable": false},
  ...
  function setURLData(name, pass, id)
  {
  ...
  function generate()
  {
    ...
    var url = '';
      //var selfDNS ="http://testpanelvenomtv.ddns.net:8000/";
      switch (parseInt(type))
      {
      case 1:
          url = dns + "get.php?username=" + window.line_name + "&password=" + window.line_pass + "&type=dreambox&output=hls";
          //url = selfDNS + "get.php?username=" + window.line_name + "&password=" + window.line_pass + "&type=dreambox&output=hls";
          break;
      case 2:
