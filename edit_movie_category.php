...
if($case == 1)
{
     $connection=$edit->edit_movie_category($category_id, $_POST['category_name'], $_POST['category_label']);
    
    $text = base64_encode('Edit Movie Category Succeded. Please check with search box.');
     echo "<script>location.href='manage_movie_category.php?text=".$text."'</script>";
}   
}

    $category = $edit->get_movie_category($category_id);
}
?>
<?php
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="category_label" class="form-control" value = "<?php echo $category['movie_category_label']; ?>"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="category_name" class="form-control" value = "<?php echo $category['movie_category_name']; ?>"/>
                                            </div>                                            
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" name="save" value="Save" class="btn btn-primary pull-right" onclick="return confirm('Are you sure want to save movie category?');">
                                </div>
                            </div>
                            </form>
