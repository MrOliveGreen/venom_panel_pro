...
if(isset($_POST['delete_id']))
{
  ...
  $result = $get->delete_stream_category($id);

  if($result)
  {
    $flag = 1;
    $alert = 'Stream Category Deleted Successfully!';
  }
  else
  {
    $flag = 2;
...
if($connection==1){
 $category_obj = $get->get_categories();
}
?>
...
<div class="page-content"> 
  ...
  <ul class="breadcrumb">
    ...
    <li><a href="#"> Stream Category </a></li>
  </ul>
  <!-- END BREADCRUMB --> 
      ...
      <div class="col-md-12"> 
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Manage Stream Category</h3>
          </div>
            ...
            <table class="display" id = "table" style = "width:100%">
              ...
              <tbody>
                <?php 
				        ...
				        ?>
                <tr>
                  <td style="cursor:pointer;"><?php echo $category['stream_category_id']; ?></td>
                  <td style="cursor:pointer;"><?php echo $category['stream_category_label']; ?></td>
                  <td style="cursor:pointer;"><?php echo $category['stream_category_name']; ?></td>
                  <td>
                    <button style = "float:left; position:relative;" class="btn btn-default btn-rounded btn-sm"><a href = "edit_stream_category.php?category_id=<?php echo base64_encode($category['stream_category_id']);?>"><span class="fa fa-pencil"></span></button>
                    <form style = "float:left; position:relative;" method = "post" enctype="multipart/form-data">
                      <input type = "text" name="delete_id" value="<?php echo base64_encode($category['stream_category_id']);?>" hidden>
