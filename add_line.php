...
if(($_POST['pkg_id']=='' || $_POST['pkg_id']==NULL) && $case != 0)
{
    ...
    if(strpos($_POST['pkg_id'], "c") === false)
        $pkg = $insert->get_package($_POST['pkg_id']);
    else
    {
...
if($case == 1)
{
     $connection=$insert->add_line($_POST['line_name'],$pass,$pkg,isset($_POST['line_mac'])? $_POST['line_mac']: NULL,isset($_POST['line_note'])? $_POST['line_note']: NULL, isset($_POST['bouquets'])? $_POST['bouquets']: '');
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <?php while($pkg = mysqli_fetch_assoc($packages)){
                                                    if(strstr($_SESSION['user_info']['user_package_id'], $pkg['package_id']))
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" name="save" value="Save" class="btn btn-primary pull-right" onclick="return confirm('Are you sure want to add line? You will lose some credits. ');">
                                </div>
                            </div>
                            </form>
