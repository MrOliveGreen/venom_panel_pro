...
if(isset($_POST['delete_id']))
{
  ...
  $result = $get->delete_movie_category($id);
...
if($connection==1){
 $category_obj = $get->get_movie_categories();
}
?>
      ...
      <div class="col-md-12"> 
        ...
        <div class="panel panel-default">
          <div class="panel-heading">
            <h3 class="panel-title">Manage Movie Category</h3>
          </div>
            ...
            <table class="display" id = "table" style = "width:100%">
              ...
              <tbody>
                <?php 
				        ...
				        ?>
                <tr>
                  <td style="cursor:pointer;"><?php echo $category['movie_category_id']; ?></td>
                  <td style="cursor:pointer;"><?php echo $category['movie_category_label']; ?></td>
                  <td style="cursor:pointer;"><?php echo $category['movie_category_name']; ?></td>
                  <td>
                    <button style = "float:left; position:relative;" class="btn btn-default btn-rounded btn-sm"><a href = "edit_movie_category.php?category_id=<?php echo base64_encode($category['movie_category_id']);?>"><span class="fa fa-pencil"></span></button>
                    <form style = "float:left; position:relative;" method = "post" enctype="multipart/form-data">
                      <input type = "text" name="delete_id" value="<?php echo base64_encode($category['movie_category_id']);?>" hidden>
