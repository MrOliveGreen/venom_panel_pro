...
if($case == 1)
{
    $connection=$insert->add_package($_POST['name'], $_POST['duration_in'], $_POST['duration'], $_POST['credit']);
    
    $text = base64_encode('Add Package Succeded. Please check with search box.');
  ...
  ?>
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Add Package</h2>
                </div>
                <!-- END PAGE TITLE -->                
