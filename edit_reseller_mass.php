...
if(!isset($_POST['users']) && $case !=0)
{
  $case=0;
  $error="<li>Please Choose Some Resellers.</li>";  
}
...
if($connection==1){
  ...
  $connection = $insert->edit_mass_user($_POST['users'], isset($_POST['packages']) ? $_POST['packages'] : '', isset($_POST['bouquets']) ? $_POST['bouquets'] : '');
	
	   $text = base64_encode('Edit Mass User Succeded. Please check with search box.');
...
<div class="page-content"> 
  ...
  <ul class="breadcrumb">
    ...
    <li class="active">Mass Edit Reseller</li>
  </ul>
  <!-- END BREADCRUMB --> 
        ...
        <form class="form-horizontal" enctype="multipart/form-data" method="post">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title"><strong>Mass Edit</strong> Reseller</h3>
              ...
              <div class="form-group">
                  ...
                  <div class="col-md-6 col-xs-12">                                            
                      <div class="input-group">
                          ...
                          <select name = "users[ ]" class="multiselect" multiple='multiple'>
                            <?php
