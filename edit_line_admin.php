                                ...
                                <div class="panel-body">                    
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="line_pass" class="form-control" placeholder="Leave it blank to generate it automatically" value = "<?php echo $line['line_pass'];?>"/>
                                            </div>                                            
                                                ...
                                                <select name = "user_id" style = "border-radius: 4px; height:30px; width:160px;">
                                                  <?php
                                                    while($user = mysqli_fetch_assoc($users))
                                                        echo "<option value='".$user['user_id']."'".($user['user_id'] == $line['line_user_id'] ? "selected" : "").">".$user['user_name']."</option>";
                                                  ?>
                                                </select>
                                            </div>                                            
                                            <span class="help-block">Enter Line Password</span>
                                    ...
                                    <div class="col-md-6 col-xs-12">
                                      <div class="input-group">
                                        <div class="input-append date" id="datetimepicker" data-date="12-02-2012 00:00" date-format="dd-mm-yyyy h:i">
                                            <input style = "height:32px; border-radius: 4px;"size="24" name = "expire_date" type="text" value = "<?php
                                            if($line['line_expire_date'] != '')
                                                echo date("m-d-Y h:i", $line['line_expire_date']);
                                            else
                                                echo '0';
                                            ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="connection" class="form-control" value = "<?php echo $line['line_connection'];?>"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="ip" class="form-control taginput" placeholder = "add ip and press enter" value = "<?php echo $line['line_allowed_ip'];?>"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="ua" class="form-control taginput" placeholder = "add ua and press enter" value = "<?php echo $line['line_allowed_ua'];?>"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="isp" class="form-control taginput" placeholder = "add ip and press enter" value = "<?php echo $line['line_allowed_isp'];?>"/>
                                            </div>                                            
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                          <div class="input-group" style = "margin-top: 5px;"> 
                                            <label>
                                            <input type="checkbox" name = "restreamer" class="flat-green" <?php echo $line['line_is_restreamer'] == '1' ? "checked" : "";?>>
                                          </label>
                                          </div>
