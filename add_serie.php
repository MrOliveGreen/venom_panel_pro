...
if($case == 1)
{
     $connection=$insert->add_serie(isset($_POST['tmdb_id']) ? $_POST['tmdb_id'] : '', isset($_POST['imdb_name']) ? $_POST['imdb_name'] : '', $_POST['panel_name'],  $_POST['category'],isset($_POST['genre']) ? $_POST['genre'] : '', isset($_POST['director']) ? $_POST['director'] : '', isset($_POST['release']) ? $_POST['release'] : '', isset($_POST['description']) ? $_POST['description'] : '', isset($_POST['poster']) ? $_POST['poster'] : '', isset($_POST['lang']) ? $_POST['lang'] : 'en');
    
    $text = base64_encode('Add Serie Succeded. Please check with search box.');
  ...
  ?>
            ...
            <div class="page-content">
                ...
                <div class="page-title">                    
                    <h2><span class="fa fa-arrow-circle-o-left"></span> Add Serie </h2>
                </div>
                <!-- END PAGE TITLE -->                
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="imdb_name" class="form-control" id = "imdb_title" />
                                            </div>                                            
                                            <span class="help-block">Enter Serie Name</span>
                                            <input type="text" name="tmdb_id" class="form-control" id = "tmdb_index" hidden/>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <?php 
                                                    while($category = mysqli_fetch_assoc($categories))
                                                        echo '<option value = "'.$category['serie_category_id'].'">'.$category['serie_category_name'].'</option>';
                                                ?>
                                                </select>
                                            </div>                                            
