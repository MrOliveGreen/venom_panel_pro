...
if($case == 1)
{
     $connection=$insert->add_stream_category($_POST['category_name'], $_POST['category_label']);
    
    $text = base64_encode('Add Stream Category Succeded. Please check with search box.');
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-footer">
                                    ...
                                    <input type="submit" name="save" value="Save" class="btn btn-primary pull-right" onclick="return confirm('Are you sure want to add stream category?');">
                                </div>
                            </div>
                            </form>
